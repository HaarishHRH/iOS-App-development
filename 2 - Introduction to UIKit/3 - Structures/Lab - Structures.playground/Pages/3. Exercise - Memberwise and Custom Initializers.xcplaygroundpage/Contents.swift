...
var favoriteBook = Book(title: "The silent patient", author: "Alex michaelides", page: 339, price: 170)
print("Name of the book : \(favoriteBook.title) Name of the author : \(favoriteBook.author) No of pages = \(favoriteBook.page) Price of the book = \(favoriteBook.price)")
/*:
...
var laptop = Laptop(yearPurchased: 2019)
var laptop1 = Laptop(yearPurchased: 2022)
print(laptop)
print(laptop1)
...
var someoneHeight = Height(heightInInches: 65.0)
...
var myHeight = Height(heightInCentimeters: 184.0)
