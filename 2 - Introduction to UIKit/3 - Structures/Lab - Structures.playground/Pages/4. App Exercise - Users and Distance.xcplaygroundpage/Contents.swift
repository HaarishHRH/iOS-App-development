...
struct User{
    ...
    var height : Double
    var weight : Double
    var activiyLevel : Int
}

//:  Create a variable instance of `User` and call it your name. Use the memberwise initializer to pass in information about yourself. Then print out a description of your `User` instance using the instance's properties.
var haarish = User(name: "Haarish", age: 19, height: 184, weight: 75, activiyLevel: 9)
print(haarish.name,haarish.age,haarish.height,haarish.weight,haarish.activiyLevel)
...
var someOtherDistance = Distance(feet: 5249.344)
