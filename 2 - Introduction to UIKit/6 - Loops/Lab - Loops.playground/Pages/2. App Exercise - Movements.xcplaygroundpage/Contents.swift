...
for (movementTracked) in movements{
    print(movementTracked)
}
...
for (exercise,avgHeartRate) in movementHeartRates{
    print("Your average heart rate while \(exercise) is \(avgHeartRate)")
}
